    ...
    <div>
      <div className="mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t mt-6 border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="text-4xl my-2 mb-8 font-bold tracking-tight text-gray-900">Cart</h1>
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                      <div className="text-gray-500">
                        <label htmlFor="quantity" className="inline mr-5 text-sm font-sm leading-6 text-gray-900">
                          Qty
                        </label>
                        <select>
